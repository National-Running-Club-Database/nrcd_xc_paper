"""
Script to create RQ1 overlay plots for 2023 data.
...
# Set output directory - create a dedicated directory for 2023 overlay plots
base_dir = os.path.dirname(script_dir)  # Parent of scripts directory
output_dir = os.path.join(base_dir, 'key_visualizations', 'RQ1', 'overlay_2023')
...
def create_overlay_plot(df_diff, year, mode, output_path):
    ...
    if len(men_df) > 0:
        for num_races in race_counts:
            ...
            # Truncate first race minutes to whole numbers for binning (floor operation)
...
def main():
    """Main function to create overlay plots for 2023."""
    print("="*60)
    print("CREATING RQ1 OVERLAY PLOTS FOR 2023")
    print("="*60)
    print(f"Data directory: {data_dir}")
    print(f"Date range: August 25, 2023 to November 27, 2023")
    print("="*60)
    ...
    print(f"\nDate range used: August 25, 2023 to November 27, 2023")
