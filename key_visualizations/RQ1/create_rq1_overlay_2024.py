"""
Script to create RQ1 overlay plots for 2024 data.
...
# Set output directory - create a dedicated directory for 2024 overlay plots
base_dir = os.path.dirname(script_dir)  # Parent of scripts directory
output_dir = os.path.join(base_dir, 'key_visualizations', 'RQ1', 'overlay_2024')
...
def main():
    """Main function to create overlay plots for 2024."""
    print("="*60)
    print("CREATING RQ1 OVERLAY PLOTS FOR 2024")
    print("="*60)
    print(f"Data directory: {data_dir}")
    print(f"Date range: August 25, 2024 to November 27, 2024")
    print("="*60)
    ...
    print(f"\nDate range used: August 25, 2024 to November 27, 2024")
