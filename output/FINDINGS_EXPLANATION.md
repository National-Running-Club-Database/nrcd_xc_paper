# Comprehensive Research Findings Explanation (LEGACY — DO NOT CITE)

> **SUPERSEDED — do not use numbers from this file in the manuscript or
> `findings.md`.** This artifact was generated by an older pipeline that
> included endpoint leakage (`last_time` among predictors) and reports
> inflated R² ≈ 0.91. The current leakage-controlled compact primary is
> SVR R² ≈ 0.043 (men) / −0.029 (women).
>
> Canonical summary: [`../findings.md`](../findings.md)
> Canonical table: `output/rq1/feature_exclusion_audit/compact_six_models.csv`
>
> Retained only for provenance of the pre-compact pipeline.

*Auto-generated from analysis results (legacy)*
